                    ...
                    <section className="bg-gradient-to-br from-orange-300 to-rose-600 h-screen">
                        ...
                        <header>
                            ...
                            <div className="flex justify-between mx-5">
                                <input className="ms-5 w-3/4 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-300 p-3" type="search" placeholder="Buscar partida" onChange={filtrarPartidas} />
